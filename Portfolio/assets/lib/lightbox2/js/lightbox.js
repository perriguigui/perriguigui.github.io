...
(function( $, undefined ) {
  ...
  // lightbox takes other approach: there are many elements (anchors) the plugin
  ...
  // of the first matched element â€“ the first element in the DOM that lightbox
  ...
  // Since in lightbox we donâ€™t operate on elements directly but only get their
  // urls, all methods are placed in the extended scope of the plugin:
  // â€˜$.ui.lightbox.globalâ€™. An instance â€˜thisâ€™ scope is merely used when we
  // use options.
  $.extend($.ui.lightbox, {
    global: {
              ...
              function( index, regExp ) {
                ...
                if ( _res !== null ) {
                  ...
                  if ( content.type === "image" || content.type === "flash" || thisElement.options.overwriteTitle )Â {
                    ...
                    _result.subtitle = $anchor.attr(Â "subtitle"Â );
                    _result.url = _url;
                  }
      ...
      getLightbox: function()Â {
        ...
        if ( !$lb.root )Â {
          ...
          $( window ).bind( "resize.lightbox", $.proxy(this.liveResize, this)Â );
      ...
      removeSetElement: function( number )Â {
        ...
        // the method prevents lightbox from being acted upon such content
        var data = this.data,
          sets = this.sets,
          _currentSet = data.currentSet,
      ...
      setOpenQueue: function() {
        ...
        var $lb = this.$lightbox,
          queueList = [
            ...
            $.proxy( this.queueCentelightbox, this ),
            $.proxy( this.queueLoadContent, this ),
            $.proxy( this.queueResizeLightbox, this ),
            $.proxy( this.queueCenterContent, this ),
            $.proxy( this.queueShowContent, this ),
      ...
      setReferences: function() {
        ...
        $lb.headerSubWrapper = $lb.header.find(Â "#ui-lightbox-subtitle-wrapper"Â );			
      ...
      updateSubTitle: function() {
        ...
        if ( _currentElement.subtitle !== "" ) {
          ...
          // keep the line height â€“ prevent counter from popping up in the subtitle line
          $lb.subtitle.append( "&nbsp;" );
        }
      },	 
      ...
      updateSubTitleWidth: function()Â {
        var $lb = this.$lightbox;
      ...
      queueCentelightbox: function( next ) {
        var $lb = this.$lightbox,
          $root = $lb.root,
